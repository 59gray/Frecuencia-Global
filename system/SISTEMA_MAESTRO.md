...
| 2 | Content Strategy | [`AGENT_02_Content_Strategy.md`](agents/AGENT_02_Content_Strategy.md) | Pilares, series, calendario y briefs (ejecuta mandato de AGENT_13) |
...
### Célula editorial profesional (capa 13-18)

Capa explícita de línea editorial, evidencia, shortform, narrativa visual, cultura electrónica y distribución. Opera **junto** a los agentes core 01-07; **AGENT_02** ejecuta calendario y briefs bajo mandato de **AGENT_13**. Documentación operativa: [`system/editorial/README_CELULA_EDITORIAL.md`](editorial/README_CELULA_EDITORIAL.md), flujo E2E [`FLUJO_EDITORIAL_E2E.md`](editorial/FLUJO_EDITORIAL_E2E.md), matriz [`MATRIZ_DECISION_EDITORIAL.md`](editorial/MATRIZ_DECISION_EDITORIAL.md).

| # | Código | Agente | Archivo | Responsabilidad clave |
|---|--------|--------|---------|------------------------|
| 13 | FG_ED_LEAD | Editorial Lead | [`AGENT_13_Editorial_Lead.md`](agents/AGENT_13_Editorial_Lead.md) | Línea editorial, veto temático, matriz de decisión, «line fit» en piezas sensibles |
| 14 | FG_RES_FC | Research + Fact-Check RI | [`AGENT_14_Research_Factcheck_RI.md`](agents/AGENT_14_Research_Factcheck_RI.md) | ResearchPack, ClaimSheet, bloqueo factual |
| 15 | FG_SCR_SHORT | Script Shortform | [`AGENT_15_Script_Shortform.md`](agents/AGENT_15_Script_Shortform.md) | Carrusel, captions, threads; sin inventar datos |
| 16 | FG_VIS_NAR | Visual-Narrative | [`AGENT_16_Visual_Narrative.md`](agents/AGENT_16_Visual_Narrative.md) | Storyboard textual, handoff a AGENT_05 |
| 17 | FG_CULT_EDM | Curador Cultura Electrónica | [`AGENT_17_Electronic_Culture_Curator.md`](agents/AGENT_17_Electronic_Culture_Curator.md) | Metáforas y ángulo bass/EDM sin sustituir fuentes |
| 18 | FG_AUD_DIST | Audiencia y Distribución | [`AGENT_18_Audience_Distribution.md`](agents/AGENT_18_Audience_Distribution.md) | Spec por plataforma, hooks, repurposing |

**Jerarquía editorial:** Lead (posicionamiento) y Research (hechos publicables) prevalecen sobre Script y Curador en conflicto; empate Lead+Research escala a Farid (editor humano) en menos de 24 h.
...
### Flujo I: Pieza editorial con célula 13-18 (recomendado shortform / carrusel)

`IdeaCard -> AGENT_13 valida tema -> AGENT_02 brief (bajo Lead) -> AGENT_14 ResearchPack + ClaimSheet -> AGENT_15 ScriptPack -> AGENT_17 (opcional) + AGENT_16 VisualBrief -> AGENT_05 export -> AGENT_06 QA -> PublishReady -> AGENT_18 DistSpec + métricas`

> Detalle: [`system/editorial/FLUJO_EDITORIAL_E2E.md`](editorial/FLUJO_EDITORIAL_E2E.md)
...
| IdeaCard / ClaimSheet / VisualBrief / DistSpec | [`03_Editorial/_specs/`](../03_Editorial/_specs/) | Célula editorial 13–18 |
...
| 2026-04-03 | Definida fuente de verdad operativa (GitHub datastore) y contrato de datos en `system/FUENTE_DE_VERDAD_Y_CONTRATO.md` | Copilot |
| 2026-04-03 | Creado checklist de configuración n8n Cloud en `08_n8n/docs/CHECKLIST_CONFIGURACION_CLOUD.md` | Copilot |
| 2026-04-03 | Creado blueprint de migración a Power Platform/Dataverse en `90_Copilot_Studio_Integration/10_blueprint_dataverse.md` | Copilot |
| 2026-04-05 | Resuelto conflicto de merge en este documento; añadida célula editorial AGENT_13-18, Flujo I, carpeta `system/editorial/` | Sistema |
